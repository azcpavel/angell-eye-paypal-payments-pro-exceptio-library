...
class Payments_pro extends EX_Controller 
{
	...
	function index()
	{
		$this->view->page('paypal/payments_pro_demo');
	}
	...
	function Do_capture()
	{
		...
		if(!$this->Paypal_pro->APICallSuccessful($PayPalResult['ACK']))
		{
			...
			$this->view->page('paypal/paypal_error',$errors);
		}
		else
		{
	...
	function Do_direct_payment_demo()
	{
		...
		else
		{
			...
			$this->view->page('paypal/do_direct_payment_demo',$data);
		}
	}
	...
	{		
		...
		else
		{
			// Successful call.  Load view or whatever you need to do here.
			$data = array('PayPalResult'=>$PayPalResult);
			$this->view->page('paypal/get_balance',$data);
		}
	}
